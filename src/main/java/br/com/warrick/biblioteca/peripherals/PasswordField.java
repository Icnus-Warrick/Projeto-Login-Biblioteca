...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (showAndHide) {
                    int x = getWidth() - 25;
                    if (new Rectangle(x, 20, 20, 20).contains(me.getPoint())) {
                        hide = !hide;
                        if (hide) {
                            setEchoChar('*');
                        } else {
        ...
        eye = new ImageIcon(getClass().getResource("/br/com/warrick/biblioteca/peripherals/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/br/com/warrick/biblioteca/peripherals/eye_hide.png")).getImage();
    ...
    private void createHintText(Graphics2D g2) {
        ...
        double height = getHeight() - in.top - in.bottom + 15;
        ...
        g2.drawString(labelText, in.right, (int) (in.top + textY - 5 + ft.getAscent() - size - 5));
    }
